...
public class JjgFbgcJagcServiceImpl implements JjgFbgcJagcService {
    ...
    public void getFile(String workpath, String proname, String htd) {
        ...
        list.add(new File(workpath +File.separator+htd+File.separator+ "57交安标线黄线逆反射系数.xlsx"));
        list.add(new File(workpath +File.separator+htd+File.separator+ "56交安标志.xlsx"));
