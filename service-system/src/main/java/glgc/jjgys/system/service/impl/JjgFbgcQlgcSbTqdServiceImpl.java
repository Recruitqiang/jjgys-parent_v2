...
public class JjgFbgcQlgcSbTqdServiceImpl extends ServiceImpl<JjgFbgcQlgcSbTqdMapper, JjgFbgcQlgcSbTqd> implements JjgFbgcQlgcSbTqdService {
                            ...
                            new ExcelHandler<JjgFbgcQlgcSbTqdVo>(JjgFbgcQlgcSbTqdVo.class) {
                                ...
                                public void handle(List<JjgFbgcQlgcSbTqdVo> dataList) {
                                    ...
                                    for(JjgFbgcQlgcSbTqdVo sbTqdVo: dataList)
                                    {
                                        ...
                                        fbgcQlgcSbTqd.setUsername(commonInfoVo.getUsername());
    ...
    public int selectnum(String proname, String htd) {
        int selectnum = jjgFbgcQlgcSbTqdMapper.selectnums(proname, htd);
        return selectnum;
    }

    @Override
    public int selectnumname(String proname) {
        int selectnum = jjgFbgcQlgcSbTqdMapper.selectnumname(proname);
        return selectnum;
    }
}
