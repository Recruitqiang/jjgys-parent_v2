 ...
 */
@Service
public class JjgFbgcSdgcZdhmcxsServiceImpl extends ServiceImpl<JjgFbgcSdgcZdhmcxsMapper, JjgFbgcSdgcZdhmcxs> implements JjgFbgcSdgcZdhmcxsService {

    @Autowired
    private JjgFbgcSdgcZdhmcxsMapper jjgFbgcSdgcZdhmcxsMapper;
    ...
    public void generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        for (Map<String, Object> map : lxlist) {
            ...
            int num = jjgFbgcSdgcZdhmcxsMapper.selectcdnum(proname,htd,zx);
    ...
    private void handlezxData(String proname, String htd, int cdsl,String sjz) throws IOException, ParseException {
        ...
        List<Map<String,Object>> datazf = jjgFbgcSdgcZdhmcxsMapper.selectzfList(proname,htd);
        List<Map<String,Object>> datayf = jjgFbgcSdgcZdhmcxsMapper.selectyfList(proname,htd);
    ...
    public List<Map<String, Object>> lookJdbjg(CommonInfoVo commonInfoVo) throws IOException {
        ...
        File f = new File(filepath + File.separator + proname + File.separator + htd + File.separator + "50隧道摩擦系数.xlsx");
        int pronamecl = 0;
        int htdcl = 0;
        if (cds == 2){
            pronamecl = 1;
    ...
    public void exportmcxs(HttpServletResponse response, String cdsl) throws IOException {
        ...
        ExcelUtil.writeExcelMultipleSheets(response, null, fileName, sheetName, new JjgFbgcSdgcZdhmcxsVo());
        ...
        for (int i = 0; i < number; i++) {
            ...
            try {
                EasyExcel.read(file.getInputStream())
                        .sheet(sheetIndex)
                        .head(JjgFbgcSdgcZdhmcxsVo.class)
                        .headRowNumber(1)
                        .registerReadListener(
                                new ExcelHandler<JjgFbgcSdgcZdhmcxsVo>(JjgFbgcSdgcZdhmcxsVo.class) {
                                    @Override
                                    public void handle(List<JjgFbgcSdgcZdhmcxsVo> dataList) {
                                        for(JjgFbgcSdgcZdhmcxsVo mcxsVo: dataList)
                                        {
                                            JjgFbgcSdgcZdhmcxs mcxs = new JjgFbgcSdgcZdhmcxs();
                                            ...
                                            jjgFbgcSdgcZdhmcxsMapper.insert(mcxs);
                                        }
                                    }
                                }
                        ).doRead();
