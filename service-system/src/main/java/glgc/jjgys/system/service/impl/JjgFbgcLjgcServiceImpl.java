...
public class JjgFbgcLjgcServiceImpl implements JjgFbgcLjgcService {
    ...
    @Override
    public void getFile(String workpath, String htd) {//String workpath=filespath+ File.separator+proname;
        ...
        List<File> list=new ArrayList<>();
        list.add(new File(workpath+File.separator+htd+File.separator+"08路基涵洞砼强度.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"09路基涵洞结构尺寸.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"04路基排水断面尺寸.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"05路基排水铺砌厚度.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"01路基土石方压实度.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"01路基压实度沉降.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"02路基弯沉(贝克曼梁法).xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"02路基弯沉(落锤法).xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"03路基边坡.xlsx"));
        list.add(new File(workpath+File.separator+htd+File.separator+"07路基小桥结构尺寸.xlsx"));
