...
public class JjgFbgcQlgcQmhpServiceImpl extends ServiceImpl<JjgFbgcQlgcQmhpMapper, JjgFbgcQlgcQmhp> implements JjgFbgcQlgcQmhpService {
            ...
            for (Map<String, Object> m : qlmclist)
            {
                for (String k : m.keySet()){
                    ...
                    if (substring.equals("Z") || substring.equals("Y")){
                        DBtoExcelZYql(proname,htd,fbgc,qlmc,username);
                    }else {
     ...
     * @param username
     */
    private void DBtoExcelql(String proname, String htd, String fbgc, String qlmc, String username) throws IOException, ParseException {
     ...
     * @throws IOException
     */
    private void DBtoExcelZYql(String proname, String htd, String fbgc, String qlmc, String username) throws IOException, ParseException {
        XSSFWorkbook wb = null;
        QueryWrapper<SysUser> sysUserQueryWrapper = new QueryWrapper<>();
        sysUserQueryWrapper.eq("username", username);
        SysUser one = sysUserService.getOne(sysUserQueryWrapper);
                            ...
                            new ExcelHandler<JjgFbgcQlgcQmhpVo>(JjgFbgcQlgcQmhpVo.class) {
                                ...
                                public void handle(List<JjgFbgcQlgcQmhpVo> dataList) {
                                    ...
                                    for(JjgFbgcQlgcQmhpVo fbgcQlgcQmhpVo: dataList)
                                    {
                                        ...
                                        if (!StringUtils.isNumeric(fbgcQlgcQmhpVo.getSjz()) || StringUtils.isEmpty(fbgcQlgcQmhpVo.getSjz())) {
                                            throw new JjgysException(20001, "第"+rowNumber+"行的数据中，设计值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(fbgcQlgcQmhpVo.getYxps()) || StringUtils.isEmpty(fbgcQlgcQmhpVo.getYxps())) {
                                        ...
                                        fbgcQlgcQmhp.setUsername(commonInfoVo.getUsername());
