    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz, String username) throws IOException, ParseException {
        ...
        if (zx.equals("主线")){
            ...
            if (rolecode.equals("YH")){
                datazf = jjgZdhGzsdMapper.selectzfListyh(proname,htd,zx,username);
                datayf = jjgZdhGzsdMapper.selectyfListyh(proname,htd,zx,username);
            }else {
                datazf = jjgZdhGzsdMapper.selectzfList(proname,htd,zx);
                datayf = jjgZdhGzsdMapper.selectyfList(proname,htd,zx);
            }
            ...
            if (rolecode.equals("YH")){
                if (jjgLqsSdzf.size()>0){
                    for (JjgLqsSd jjgLqsSd : jjgLqsSdzf) {
                        ...
                        hpsdzfdata.addAll(jjgZdhGzsdMapper.selectSdZfDatayh(proname,htd,zx,zhq,zhz,username));
                    }
                }
                ...
                if (jjgLqsSdyf.size()>0){
                    for (JjgLqsSd jjgLqsSd : jjgLqsSdyf) {
                        String zhq = String.valueOf(jjgLqsSd.getZhq());
                        String zhz = String.valueOf(jjgLqsSd.getZhz());
                        hpsdyfdata.addAll(jjgZdhGzsdMapper.selectSdyfDatayh(proname,htd,zx,zhq,zhz,username));
                    }
                }
                ...
                if (jjgLqsQlzf.size()>0){
                    for (JjgLqsQl jjgLqsQl : jjgLqsQlzf) {
                        ...
                        hpqlzfdata.addAll(jjgZdhGzsdMapper.selectQlZfDatayh(proname,htd,zx,zhq,zhz,username));
                    }
                }
                ...
                if (jjgLqsQlyf.size()>0){
                    for (JjgLqsQl jjgLqsQl : jjgLqsQlyf) {
                        String zhq = String.valueOf(jjgLqsQl.getZhq());
                        String zhz = String.valueOf(jjgLqsQl.getZhz());
                        hpqlyfdata.addAll(jjgZdhGzsdMapper.selectQlYfDatayh(proname,htd,zx,zhq,zhz,username));
                    }
                }
            }else {
                if (jjgLqsSdzf.size()>0){
            ...
            if (rolecode.equals("YH")){
                dataljxzf = jjgZdhGzsdMapper.selectzfListyh(proname,htd,zx,username);
                dataljxyf = jjgZdhGzsdMapper.selectyfListyh(proname,htd,zx,username);
            }else {
                dataljxzf = jjgZdhGzsdMapper.selectzfList(proname,htd,zx);
                dataljxyf = jjgZdhGzsdMapper.selectyfList(proname,htd,zx);
            }
            ...
            if (rolecode.equals("YH")){
                for (JjgLjx jjgLjx : jjgLjxList) {
                    ...
                    for (JjgLqsSd jjgLqsSd : jjgLqssd) {
                        ...
                        sdmcxs.addAll(jjgZdhGzsdMapper.selectsdgzsdyh(proname,bz,lf,sdzhq,sdz,zx,zhq1,zhz1,username));
                    }
                    ...
                    for (JjgLqsQl jjgLqsQl : jjgLqsql) {
                        ...
                        qlmcxs.addAll(jjgZdhGzsdMapper.selectqlgzsdyh(proname,bz,lf, qlzhq, qlzhz, zx, zhq1, zhz1,username));
            ...
            //匝道
            if (rolecode.equals("YH")){
                datazdzf = jjgZdhGzsdMapper.selectzfListyh(proname,htd,zx,username);
                datazdyf = jjgZdhGzsdMapper.selectyfListyh(proname,htd,zx,username);
            }else {
                datazdzf = jjgZdhGzsdMapper.selectzfList(proname,htd,zx);
                datazdyf = jjgZdhGzsdMapper.selectyfList(proname,htd,zx);
            }
