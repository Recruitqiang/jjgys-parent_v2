...
public class JjgFbgcQlgcZdhgzsdServiceImpl extends ServiceImpl<JjgFbgcQlgcZdhgzsdMapper, JjgFbgcQlgcZdhgzsd> implements JjgFbgcQlgcZdhgzsdService {
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz, String username) throws IOException, ParseException {
        ...
        if (rolecode.equals("YH")){
            datazf = jjgFbgcQlgcZdhgzsdMapper.selectzfListyh(proname, htd,zx,username);
            datayf = jjgFbgcQlgcZdhgzsdMapper.selectyfListyh(proname, htd,zx,username);
        }else {
            datazf = jjgFbgcQlgcZdhgzsdMapper.selectzfList(proname, htd,zx);
            datayf = jjgFbgcQlgcZdhgzsdMapper.selectyfList(proname, htd,zx);
        }
    ...
    private List<Map<String, Object>> lookdata(String proname, String htd, String zx, int cds) throws IOException {
        ...
        File f = new File(filepath + File.separator + proname + File.separator + htd + File.separator + "37桥面构造深度-"+zx+".xlsx");
        if (!f.exists()) {
            return new ArrayList<>();
        } else {
    ...
    public List<Map<String, Object>> lookJdb(CommonInfoVo commonInfoVo, String value) throws IOException {
        ...
        int cds = jjgFbgcQlgcZdhgzsdMapper.selectcdnum(proname,htd,qlmc);
