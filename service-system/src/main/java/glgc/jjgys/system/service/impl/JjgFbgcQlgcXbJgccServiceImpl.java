...
public class JjgFbgcQlgcXbJgccServiceImpl extends ServiceImpl<JjgFbgcQlgcXbJgccMapper, JjgFbgcQlgcXbJgcc> implements JjgFbgcQlgcXbJgccService {
    ...
    public void exportqlxbjgcc(HttpServletResponse response) {
        String fileName = "02桥梁下部结构尺寸实测数据";
                            ...
                            new ExcelHandler<JjgFbgcQlgcXbJgccVo>(JjgFbgcQlgcXbJgccVo.class) {
                                ...
                                public void handle(List<JjgFbgcQlgcXbJgccVo> dataList) {
                                    ...
                                    for(JjgFbgcQlgcXbJgccVo xbJgccVo: dataList)
                                    {
                                        ...
                                        if (!StringUtils.isNumeric(xbJgccVo.getScz()) || StringUtils.isEmpty(xbJgccVo.getScz())) {
                                        ...
                                        xbJgcc.setUsername(commonInfoVo.getUsername());
    ...
    public int selectnum(String proname, String htd) {
        int selectnum = jjgFbgcQlgcXbJgccMapper.selectnums(proname, htd);
        return selectnum;
    }

    @Override
    public int selectnumname(String proname) {
        int selectnum = jjgFbgcQlgcXbJgccMapper.selectnumname(proname);
        return selectnum;
    }
}
