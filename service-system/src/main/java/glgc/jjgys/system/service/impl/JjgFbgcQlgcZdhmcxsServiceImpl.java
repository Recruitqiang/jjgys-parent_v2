...
public class JjgFbgcQlgcZdhmcxsServiceImpl extends ServiceImpl<JjgFbgcQlgcZdhmcxsMapper, JjgFbgcQlgcZdhmcxs> implements JjgFbgcQlgcZdhmcxsService {
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz, String username) throws IOException, ParseException {
        ...
        if (rolecode.equals("YH")){
            datazf = jjgFbgcQlgcZdhmcxsMapper.selectzfListyh(proname, htd,zx,username);
            datayf = jjgFbgcQlgcZdhmcxsMapper.selectyfListyh(proname, htd,zx,username);
        }else {
            datazf = jjgFbgcQlgcZdhmcxsMapper.selectzfList(proname, htd,zx);
            datayf = jjgFbgcQlgcZdhmcxsMapper.selectyfList(proname, htd,zx);
        }
