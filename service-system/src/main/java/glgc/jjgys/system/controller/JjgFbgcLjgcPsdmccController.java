...
public class JjgFbgcLjgcPsdmccController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLjgcPsdmcc != null){
            ...
            String username = jjgFbgcLjgcPsdmcc.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLjgcPsdmcc.getZh())){
                wrapper.like("zh",jjgFbgcLjgcPsdmcc.getZh());
            }
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLjgcPsdmcc> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLjgcPsdmccService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
