...
public class JjgFbgcLmgcHntlmhdzxfController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLmgcHntlmhdzxf != null){
            ...
            String username = jjgFbgcLmgcHntlmhdzxf.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLmgcHntlmhdzxf.getZh())) {
                wrapper.like("zh", jjgFbgcLmgcHntlmhdzxf.getZh());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLmgcHntlmhdzxf> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLmgcHntlmhdzxfService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
