...
public class JjgFbgcSdgcCqtqdController {
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcSdgcCqtqd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcSdgcCqtqdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcSdgcCqtqd != null){
            ...
            String username = jjgFbgcSdgcCqtqd.getUsername();
            QueryWrapper<SysUser> sysUserQueryWrapper = new QueryWrapper<>();
            sysUserQueryWrapper.eq("username", username);
            SysUser one = sysUserService.getOne(sysUserQueryWrapper);
            String userid = one.getId().toString();
            ...
            if (!StringUtils.isEmpty(jjgFbgcSdgcCqtqd.getSdmc())) {
                wrapper.like("sdmc", jjgFbgcSdgcCqtqd.getSdmc());
            }
            if (!StringUtils.isEmpty(jjgFbgcSdgcCqtqd.getBw1())) {
                wrapper.like("bw1", jjgFbgcSdgcCqtqd.getBw1());
            }
            if (!StringUtils.isEmpty(jjgFbgcSdgcCqtqd.getBw2())) {
                wrapper.like("bw2", jjgFbgcSdgcCqtqd.getBw2());
            }
