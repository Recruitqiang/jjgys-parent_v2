...
public class JjgFbgcLjgcLjwcLcfController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLjgcLjwcLcf != null){
            ...
            String username = jjgFbgcLjgcLjwcLcf.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLjgcLjwcLcf.getZh())){
                wrapper.like("zh",jjgFbgcLjgcLjwcLcf.getZh());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        boolean remove = jjgFbgcLjgcLjwcLcfService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
