...
public class JjgFbgcQlgcXbJgccController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcQlgcXbJgcc != null){
            ...
            String username = jjgFbgcQlgcXbJgcc.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcQlgcXbJgcc.getQlmc())) {
                wrapper.like("qlmc", jjgFbgcQlgcXbJgcc.getQlmc());
            }
            if (!StringUtils.isEmpty(jjgFbgcQlgcXbJgcc.getBw())) {
                wrapper.like("bw", jjgFbgcQlgcXbJgcc.getBw());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcQlgcXbJgcc> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcQlgcXbJgccService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
