...
public class JjgFbgcQlgcXbSzdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (JjgFbgcQlgcXbSzd != null){
            ...
            String username = JjgFbgcQlgcXbSzd.getUsername();
            ...
            if (!StringUtils.isEmpty(JjgFbgcQlgcXbSzd.getDth())) {
                wrapper.like("dth", JjgFbgcQlgcXbSzd.getDth());
            }
            if (!StringUtils.isEmpty(JjgFbgcQlgcXbSzd.getQlmc())) {
                wrapper.like("qlmc", JjgFbgcQlgcXbSzd.getQlmc());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcQlgcXbSzd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcQlgcXbSzdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
