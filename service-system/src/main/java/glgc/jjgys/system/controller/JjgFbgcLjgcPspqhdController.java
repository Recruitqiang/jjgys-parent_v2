...
public class JjgFbgcLjgcPspqhdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLjgcPspqhd != null){
            ...
            String username = jjgFbgcLjgcPspqhd.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLjgcPspqhd.getZh())){
                wrapper.like("zh",jjgFbgcLjgcPspqhd.getZh());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLjgcPspqhd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLjgcPspqhdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
