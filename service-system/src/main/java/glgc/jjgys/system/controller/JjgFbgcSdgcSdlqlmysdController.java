...
public class JjgFbgcSdgcSdlqlmysdController {
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcSdgcSdlqlmysd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcSdgcSdlqlmysdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
    ...
    public Result findQueryPageHt(@PathVariable long current,
        ...
        if (jjgFbgcSdgcSdlqlmysd != null){
            ...
            String username = jjgFbgcSdgcSdlqlmysd.getUsername();
            QueryWrapper<SysUser> sysUserQueryWrapper = new QueryWrapper<>();
            sysUserQueryWrapper.eq("username", username);
            SysUser one = sysUserService.getOne(sysUserQueryWrapper);
            String userid = one.getId().toString();
            ...
            Date jcsj = jjgFbgcSdgcSdlqlmysd.getJcsj();
            if (!StringUtils.isEmpty(jcsj)) {
                wrapper.like("jcsj", jcsj);
            }
            if (!StringUtils.isEmpty(jjgFbgcSdgcSdlqlmysd.getSdmc())) {
                wrapper.like("sdmc", jjgFbgcSdgcSdlqlmysd.getSdmc());
            }
            if (!StringUtils.isEmpty(jjgFbgcSdgcSdlqlmysd.getZh())) {
                wrapper.like("zh", jjgFbgcSdgcSdlqlmysd.getZh());
            }
            //调用方法分页查询
