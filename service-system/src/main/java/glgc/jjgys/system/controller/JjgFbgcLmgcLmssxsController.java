...
public class JjgFbgcLmgcLmssxsController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLmgcLmssxs != null){
            ...
            String username = jjgFbgcLmgcLmssxs.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLmgcLmssxs.getZh())) {
                wrapper.like("zh", jjgFbgcLmgcLmssxs.getZh());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLmgcLmssxs> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLmgcLmssxsService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
