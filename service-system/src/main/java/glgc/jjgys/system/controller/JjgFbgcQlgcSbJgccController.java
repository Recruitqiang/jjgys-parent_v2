...
public class JjgFbgcQlgcSbJgccController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcQlgcSbJgcc != null){
            ...
            String username = jjgFbgcQlgcSbJgcc.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcQlgcSbJgcc.getLbh())) {
                wrapper.like("lbh", jjgFbgcQlgcSbJgcc.getLbh());
            }
            if (!StringUtils.isEmpty(jjgFbgcQlgcSbJgcc.getQlmc())) {
                wrapper.like("qlmc", jjgFbgcQlgcSbJgcc.getQlmc());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcQlgcSbJgcc> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcQlgcSbJgccService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
