...
public class JjgFbgcLjgcZddmccController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLjgcZddmcc != null){
            ...
            String username = jjgFbgcLjgcZddmcc.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLjgcZddmcc.getZhjwz())) {
                wrapper.like("zhjwz", jjgFbgcLjgcZddmcc.getZhjwz());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLjgcZddmcc> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLjgcZddmccService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
