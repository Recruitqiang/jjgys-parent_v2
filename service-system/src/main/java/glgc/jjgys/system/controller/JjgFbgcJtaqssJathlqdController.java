...
public class JjgFbgcJtaqssJathlqdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcJtaqssJathlqd != null) {
            ...
            String username = jjgFbgcJtaqssJathlqd.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcJtaqssJathlqd.getZh())) {
                wrapper.like("zh", jjgFbgcJtaqssJathlqd.getZh());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcJtaqssJathlqd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcJtaqssJathlqdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
