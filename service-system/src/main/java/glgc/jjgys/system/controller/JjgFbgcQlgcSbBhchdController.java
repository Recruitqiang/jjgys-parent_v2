...
public class JjgFbgcQlgcSbBhchdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcQlgcSbBhchd != null){
            ...
            String username = jjgFbgcQlgcSbBhchd.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcQlgcSbBhchd.getGjbhjjcbw())) {
                wrapper.like("gjbhjjcbw", jjgFbgcQlgcSbBhchd.getGjbhjjcbw());
            }
            if (!StringUtils.isEmpty(jjgFbgcQlgcSbBhchd.getQlmc())) {
                wrapper.like("qlmc", jjgFbgcQlgcSbBhchd.getQlmc());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcQlgcSbBhchd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcQlgcSbBhchdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
