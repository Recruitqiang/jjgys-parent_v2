...
public class JjgFbgcSdgcDmpzdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcSdgcDmpzd != null){
            ...
            String username = jjgFbgcSdgcDmpzd.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcSdgcDmpzd.getSdmc())) {
                wrapper.like("sdmc", jjgFbgcSdgcDmpzd.getSdmc());
            }
            if (!StringUtils.isEmpty(jjgFbgcSdgcDmpzd.getZh())) {
                wrapper.like("zh", jjgFbgcSdgcDmpzd.getZh());
            }
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcSdgcDmpzd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcSdgcDmpzdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
