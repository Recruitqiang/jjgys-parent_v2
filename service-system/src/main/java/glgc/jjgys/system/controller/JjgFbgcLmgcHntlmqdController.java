...
public class JjgFbgcLmgcHntlmqdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLmgcHntlmqd != null){
            ...
            String username = jjgFbgcLmgcHntlmqd.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLmgcHntlmqd.getZh())) {
                wrapper.like("zh", jjgFbgcLmgcHntlmqd.getZh());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLmgcHntlmqd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLmgcHntlmqdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
