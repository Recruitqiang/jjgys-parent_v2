...
public class JjgFbgcQlgcXbBhchdController {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcQlgcXbBhchd != null){
            ...
            String username = jjgFbgcQlgcXbBhchd.getUsername();
            ...
            if (!StringUtils.isEmpty(jjgFbgcQlgcXbBhchd.getQlmc())) {
                wrapper.like("qlmc", jjgFbgcQlgcXbBhchd.getQlmc());
            }
            if (!StringUtils.isEmpty(jjgFbgcQlgcXbBhchd.getGjbhjjcbw())) {
                wrapper.like("gjbhjjcbw", jjgFbgcQlgcXbBhchd.getGjbhjjcbw());
            }
            //调用方法分页查询
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcQlgcXbBhchd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcQlgcXbBhchdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
            return Result.fail().message("删除失败！");
