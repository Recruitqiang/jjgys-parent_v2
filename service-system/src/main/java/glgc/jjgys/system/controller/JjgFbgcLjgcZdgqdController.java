...
public class JjgFbgcLjgcZdgqdController {
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        QueryWrapper<JjgFbgcLjgcZdgqd> queryWrapper = new QueryWrapper<>();
        ...
        boolean remove = jjgFbgcLjgcZdgqdService.remove(queryWrapper);
        if(remove){
            return Result.ok();
        } else {
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgFbgcLjgcZdgqd != null){
            ...
            String username = jjgFbgcLjgcZdgqd.getUsername();
            QueryWrapper<SysUser> sysUserQueryWrapper = new QueryWrapper<>();
            sysUserQueryWrapper.eq("username", username);
            SysUser one = sysUserService.getOne(sysUserQueryWrapper);
            String userid = one.getId().toString();
            ...
            if (!StringUtils.isEmpty(jjgFbgcLjgcZdgqd.getZh())) {
                wrapper.like("zh", jjgFbgcLjgcZdgqd.getZh());
            }
            //调用方法分页查询
